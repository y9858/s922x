...
git clone https://github.com/toss-a/luci-theme-atmaterial package/luci-theme-atmaterial
sed -i '529d' package/luci-theme-atmaterial/files/htdocs/css/style.css
